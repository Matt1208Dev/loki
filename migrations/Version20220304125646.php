 ...
 */
final class Version20220304125646 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        // $this->addSql("INSERT INTO user (`email`, `roles`, `password`, `full_name`) VALUES ('allard.philippe60@gmail.com', ['ROLE_ADMIN'], 'Lokiallard2022!!',  = 'Philippe Allard')");
    }
