...
final class Version20220204175203 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE apartment (id INT AUTO_INCREMENT NOT NULL, owner_id INT DEFAULT NULL, street VARCHAR(150) NOT NULL, city VARCHAR(80) NOT NULL, zip VARCHAR(6) NOT NULL, created_at DATETIME NOT NULL, INDEX IDX_4D7E68547E3C61F9 (owner_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
