...
final class Version20220204181548 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE rent (id INT AUTO_INCREMENT NOT NULL, owner_id INT NOT NULL, apartment_id INT NOT NULL, starting_date DATETIME NOT NULL, ending_date DATETIME NOT NULL, rent_type VARCHAR(20) NOT NULL, total NUMERIC(5, 2) NOT NULL, is_paid TINYINT(1) NOT NULL, settlement_date DATETIME DEFAULT NULL, deposit VARCHAR(50) NOT NULL, comment VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, INDEX IDX_2784DCC7E3C61F9 (owner_id), INDEX IDX_2784DCC176DFE85 (apartment_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
